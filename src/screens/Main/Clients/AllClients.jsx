  ...
  function renderItem(data, index) {
    return (
        ...
        <View style={ClientsStyles.card}>
          <View style={ClientsStyles.imageContainer}>
            <Image style={ClientsStyles.image} source={require("../../../assets/images/lg/avatar10.jpg")} />
            <Text style={{ fontFamily: "Poppins-ExtraBold", fontSize: 16, color: "black", textAlign: "center", }}>{data.clientLastName}</Text>
          </View>
          <View style={ClientsStyles.clientInfo}>
            <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 15 }}>{data.clientCode}</Text>
            {/* <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 15 , width:"90%"}}>{data.email}surendraku</Text> */}
            <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 15 }}>{data.mobile}</Text>
            <View style={{flexDirection:"row", marginTop: 10, flex:1  , alignItems:"center", justifyContent:"space-between", width:"60%"}}>
    ...
    <SafeAreaView style={{ flex: 1 }}>
      {loading ? (
        ...
        <View style={[backgroundStyles.whiteBackground]}>
          ...
          <>
            ...
            {ClientsData.length <= 0 && (
              <NoDataScreen caption={"No client data available"} />
            )}
          </>
        </View>
      )}
      ...
      <Modal
        ...
        <View style={ClientsStyles.modalContainerStyle}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <Text style={ClientsStyles.modalHeaderText}>Edit Member</Text>
            <View
              style={{
                borderBottomWidth: 0.5,
                borderBottomColor: 'grey',
